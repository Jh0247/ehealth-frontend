...
import { getPatientsByDoctor, getOrganizationStats } from '../../redux/features/healthcareProviderSlice';
...
export default function HealthcareDashboard() {
  ...
  const { user_info, appointments, status } = useSelector((state) => state.user);
  const { patients, statistics } = useSelector((state) => state.healthcareProvider);
      ...
      <div className="flex flex-col md:flex-row md:gap-6">
        ...
        {user_info?.user_role === 'admin' && (
          <div className="flex flex-col gap-6 mt-8">
            ...
            <div className="bg-white rounded-lg shadow-sm shadow-teal-800 p-4 flex flex-col items-center text-center">
              <h4 className="text-lg smb-2">Number of Blogposts</h4>
